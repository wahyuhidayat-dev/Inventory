<div class="row">
			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<div style="float:left">	
						<a type="button" data-toggle="modal" data-target="#modal-tambah"  class="btn btn-primary">Input Exp</a>
					</div>
					<table data-toggle="table" data-show-refresh="true" data-show-columns="true" data-search="true" data-pagination="true" data-sort-name="name" data-sort-order="desc" data-row-style="rowStyle">
						<thead>
							<tr>
								...
								<th data-field ="id7" data-sortable="true">EXPIRED DATE</th>
							</tr>
						</thead>
						<tbody>
							<?php
	...
	<div class="modal fade" id="modal-tambah" role="dialog">
		<div class="modal-dialog">
			<form action="<?php echo site_url('Exp/expired'); ?>" method="post">
