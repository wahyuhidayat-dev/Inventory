<div class="row">
			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<div style="float:left">	
						<a type="button" data-toggle="modal" data-target="#modal-tambah"  class="btn btn-primary">Input Return</a>
						<a type="button" href="<?= base_url(); ?>Returnn/excel" class="btn btn-primary">Export Excel</a>
					</div>
					<table data-toggle="table" data-show-refresh="true" data-show-columns="true" data-search="true" data-pagination="true" data-sort-name="name" data-sort-order="desc" data-row-style="rowStyle">
						<thead>
							<tr>
								...
								<th data-field ="id2" data-sortable="true">ID_RETURN</th>
								<th data-field ="id3" data-sortable="true">PROD_ID</th>
								<th data-field ="id4" data-sortable="true">PROD_NAME</th>
								<th data-field ="id5" data-sortable="true">QTY</th>
								<th data-field ="id6" data-sortable="true">DATE</th>
								<th data-field ="id7" data-sortable="true">REASON</th>
							</tr>
						</thead>
						<tbody>
							<?php 
							$no=1;
							foreach ($return->result() as $key) : ?>
							
								<tr>
									<td data-field ="id1" ><?= $no++; ?></td>
									<td data-field ="id2" ><?= $key->ID_RETURN; ?></td>
									<td data-field ="id3" ><?= $key->PROD_ID; ?></td>
									<td data-field ="id4" ><?= $key->PROD_NM; ?></td>
									<td data-field ="id5" ><?= $key->QTY_RETURN; ?></td>
									<td data-field ="id6" ><?= $key->DATE; ?></td>
									<td data-field ="id7" ><?= $key->REASON; ?></td>
								</tr>
							<?php  endforeach; ?>
	...
	<div class="modal fade" id="modal-tambah" role="dialog">
		<div class="modal-dialog">
			<form action="<?php echo site_url('Returnn/return'); ?>" method="post">
